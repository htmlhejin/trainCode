    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <button onClick={()=>this.props.increment(10)}>+</button>
                <button onClick={()=>this.props.decrement(10)}>-</button>
                <button onClick={()=>this.props.incrementAfterThree()}>3秒后加100</button>
                <button onClick={()=>this.props.promiseADD(1)}>promise减</button>
