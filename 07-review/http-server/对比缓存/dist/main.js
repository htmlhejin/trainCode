...
//   '--help' ]
_commander.default.option('-p, --port<val>', 'set myserver port') //输入-p时，设置指定端口。就像http-server -p 8000
...
Object.assign(config, _commander.default); //这个api表示把program作用到config,相当于progam中的信息复制到config中
// console.log(config)
// { port: 8080,
//     commands: [],
//     options:
